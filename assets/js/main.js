  ...
  fetch(RSS_URL)
    ...
    .then((data) => {
      ...
      for (i = 0; i < 3; i++) {
        ...
        feedhtml =
          '<div class="col-md-4 news-box"><a target="_blank" href="' +
          link_item +
          '"><h4>' +
          title_item +
          "</h4></a></div>";
    ...
    .catch((error) => {
      $(".feedrow").append(
        '<h4 class="text-center"> Παρουσιάστηκε κάποιο πρόβλημα με την ανάκτηση των δεδομένων. Μας συγχωρείτε για την αναστάτωση</h4>'
      );
    });
});
